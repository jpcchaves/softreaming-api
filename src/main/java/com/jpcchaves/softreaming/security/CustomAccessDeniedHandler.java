...
public class CustomAccessDeniedHandler implements AccessDeniedHandler {
    ...
    @Override
    public void handle(HttpServletRequest req, HttpServletResponse res, org.springframework.security.access.AccessDeniedException accessDeniedException) throws IOException, ServletException {
